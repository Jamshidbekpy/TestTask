...
#         ("Завтра в 15:00 совещание с клиентом", "Russian test"),
#         ("Каждую пятницу в 14:00 созвон", "Russian repeat"),
...
#             print(f"📌 Title: {result['extracted_data'].get('title', 'N/A')}")
#             print(f"⏰ Vaqt: {result['extracted_data'].get('time_start', 'N/A')}")
            
#             if result['extracted_data'].get('all_day'):
#                 print(f"📅 All-day: Ha")
            
#             if result['extracted_data'].get('repeat'):
#                 print(f"🔄 Repeat: {result['extracted_data']['repeat']}")
            
#             if result['extracted_data'].get('invite'):
#                 print(f"👥 Invites: {', '.join(result['extracted_data']['invite'])}")
            
#             if result['extracted_data'].get('alert'):
#                 print(f"🔔 Alerts: {', '.join(result['extracted_data']['alert'])}")
            
#             if result['suggestions']:
#                 print(f"💡 Takliflar: {', '.join(result['suggestions'])}")
